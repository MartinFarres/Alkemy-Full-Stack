...
function Register() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="email" className="block-title2 mt-3">
                Email:
            ...
            <p
                id="uidnote"
                className={
                    pwdFocus && !validPwd ? "instructions mx-2" : "offscreen"
                }
            >
                <FontAwesomeIcon icon={faInfoCircle} />
                8 to 24 characters. <br />
                Must include uppercase and lowwer case letters, a number and a
            ...
            <label htmlFor="confirm_password" className="block-title2 mt-3">
                Confirm Password:
                <FontAwesomeIcon
                    icon={faCheck}
            ...
            <p className="block-title3 mt-2">Alredy Register?</p>
            <Link to={"/Login"} className="block-title3 a3 mb-3">
                Sign In
            </Link>
        </form>
    );
